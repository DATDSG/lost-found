    ...
    return Expanded(
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: selected ? [BoxShadow(color: Colors.black.withOpacity(.06), blurRadius: 8, offset: const Offset(0, 2))] : null,
        ),
        child: InkWell(
          borderRadius: BorderRadius.circular(12),
          onTap: onTap,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            Text(value, style: DT.t.title.copyWith(color: DT.c.text.withOpacity(.8), fontWeight: FontWeight.w600)),
            const SizedBox(width: 6),
