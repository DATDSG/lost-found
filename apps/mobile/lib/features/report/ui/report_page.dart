                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: DT.s.md),
                        const _TipItem('Add clear photos for better matches'),
                        const _TipItem('Provide accurate location details'),
                        const _TipItem('Include distinctive features'),
                        const _TipItem('Check back regularly for updates'),
                      ],
                    ),
                  ),
                ),
