                ...
                return GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        if (!isMe)
                          CircleAvatar(radius: 20, backgroundColor: const Color(0xFFE6EAF2),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: _BubbleContent(msg: m, isMe: isMe),
                              ),
                            ],
                          ),
                        ),
                        if (isMe) SizedBox(width: DT.s.sm),
                        if (isMe) CircleAvatar(radius: 18, backgroundColor: const Color(0xFFE6EAF2),
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: DT.s.lg),
                    decoration: BoxDecoration(
                      color: DT.c.blueTint.withOpacity(0.55),
  ...
  Widget build(BuildContext context) {
    switch (msg.kind) {
      case MessageKind.text:
        return Text(
          ...
          style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                color: isMe ? Colors.white : DT.c.text,
                height: 1.5,
              ),
        );
      ...
      case MessageKind.video:
        // Lightweight preview without adding video_player; show a card with play icon
        return Container(
          height: 120,
          width: 220,
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        CircleAvatar(
          radius: 22,
          backgroundColor: DT.c.blueTint.withOpacity(0.6),
