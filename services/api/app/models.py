...
class User(Base):
    ...
    # Relationships
    reports = relationship("Report", foreign_keys="Report.owner_id", overlaps="owner")
...
class FraudDetectionResult(Base):
    ...
    # Relationships
    report = relationship("Report", foreign_keys=[report_id], overlaps="fraud_detection_results")
...
class FraudDetectionLog(Base):
    ...
    # Relationships
    report = relationship("Report", foreign_keys=[report_id], overlaps="fraud_detection_logs")